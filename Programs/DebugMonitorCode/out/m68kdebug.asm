...
; PC = ProgramStart, SSP=0x00880000, USP = 0x00870000;
       move.l    #8388608,_PC.L
       move.l    #8912896,_SSP.L
       move.l    #8847360,_USP.L
